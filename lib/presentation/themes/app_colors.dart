...
class AppColors {
  ...
  /// تدرج أرباح
  static const Gradient earningsGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  ...
  /// تدرج إحالة
  static const Gradient referralGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  ...
  static Color getTextColorForBackground(Color backgroundColor) {
    ...
    return brightness > 0.5 ? textPrimary : textOnPrimary;
  }

  /// الحصول على لون الحملة حسب النوع
  static Color getCampaignColor(CampaignType type) {
    switch (type) {
      case CampaignType.open:
        return campaignOpen;
      case CampaignType.regional:
        return campaignRegional;
      case CampaignType.precise:
        return campaignPrecise;
    }
  }

  /// الحصول على لون خلفية الحملة حسب النوع
  static Color getCampaignBackgroundColor(CampaignType type) {
    switch (type) {
      case CampaignType.open:
        return campaignOpenLight;
      case CampaignType.regional:
        return campaignRegionalLight;
      case CampaignType.precise:
        return campaignPreciseLight;
    }
  }
  ...
  /// الحصول على لون الأرباح حسب القيمة
  static Color getEarningsColor(double amount) {
    if (amount >= 0.05) return earningsHigh;
    if (amount >= 0.03) return earningsMedium;
    return earningsLow;
  }
}
